...
import { AttendanceData, DepartmentsListData, EmployeeListData, EmployeeSalaryData, EstimatesData, EventData, ExpensesData, FriendsData, GridViewData, HolidaysData, LeaveManageEmployeeData, LeaveManageHRData, ListViewData, OrderListData, SellersData, UserGridViewData, UserListViewData, events } from '../../data';
...
export class FakeBackendInterceptor implements HttpInterceptor {
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        if (
            request.url.startsWith('http://localhost:8080/ucacue/') ||
